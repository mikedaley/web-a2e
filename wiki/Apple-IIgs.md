...
- [The SmartPort](#the-smartport)
- [Super Hi-Res](#super-hi-res)
...
- ~~**Expansion slots** are not offered on a IIgs.~~ — done. All seven sockets take a card, and the window carries the Control Panel's per-slot setting beside each, because the two are independent on the real machine and the firmware's own Control Panel is not reachable here. See [[Expansion-Slots]].
